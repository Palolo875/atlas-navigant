        ...
        >
          ...
          <div className="relative z-10 flex-1 overflow-y-auto hide-scrollbar px-6 py-4">
            {loading && !weather ? (
              ...
              <>
                {activeTab === "weather" && (weather ? <WeatherTab weather={weather} narratives={narratives} airQuality={airQuality} /> : <EmptyState text="Donnees meteo indisponibles" />)}
                {activeTab === "air" && (airQuality ? <AirTab airQuality={airQuality} /> : <EmptyState text="Donnees air indisponibles" />)}
                {activeTab === "alerts" && (
